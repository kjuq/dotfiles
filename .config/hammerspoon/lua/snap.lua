...
M.upper_right = function()
	hs.window.focusedWindow():move(units.upper_right, nil, true)
end
M.upper_left = function()
	hs.window.focusedWindow():move(units.upper_left, nil, true)
end
M.bottom_right = function()
	hs.window.focusedWindow():move(units.bottom_right, nil, true)
end
M.bottom_left = function()
	hs.window.focusedWindow():move(units.bottom_left, nil, true)
end
